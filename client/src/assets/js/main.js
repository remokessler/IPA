(function () {
	...
	cmi.initJQ = function () {
		// TODO: remove console.log("cmi.initJQ");
	...
	cmi.initJQForElement = function (elem, services) {
		...
		// TODO: remove console.log("cmi.initJQForElement",elem);
		...
		(function ($) {
			...
			//if ($elem.find('.dropdown.open').length > 0 && $(e.target).parents('.dropdown').length === 0) {
			//    $elem.find('.dropdown.open .dropdown-toggle').trigger('click');
			//}
			//});
